	...
	implanting: [
		{
			title: 'Имплантация',
			description:
				'Имплантация - внедрение искусственного зуба в виде корня, интегрированного в кость. Главное преимущество - сохранение полной функциональности и равномерноое распределение нагрузки, в отличие от мостов и съемных протезов.',
			img: anyridge_implant,
		},
	],
