	...
	const data = [
		{
			...
			description: 'В stomaland работают грамотные врачи и ассистенты с релевантным опытом. Мы применяем ответственный подход к каждому пациенту и проводим максимально эффективное лечение.',
			image: '',
		},
		{
			title: 'Бережное отношение к пациентам',
			description: 'Мы уважаем и ценим каждого пациента и лечим так, как хотим чтобы лечили нас. Главным приоритетом для нас является сохранение натурального зуба. Удаление мы рекомендуем только в крайних случаях, когда другого выхода уже нет. ',
			image: '',
		},
		{
			title: 'Демократичные цены',
			description: 'Стоматологическая клиника stomaland придерживается лояльной политики ценообразования. Мы не "ломим" цены и предлагаем услуги премиального качества по доступным ценам.',
			image: '',
		},
		{
			title: 'Качественные материалы',
			description: 'Закупка материалов производится только у проверенных производителей и надежных партнеров. Мы категорически против использования материалов сомнительного качества.',
			image: '',
		},
	];
