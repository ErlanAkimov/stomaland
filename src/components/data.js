...
export const benefits = [
	{
		...
		text: 'Мы заботимся о наших клиентах и очень ответственно подходим к их лечению. Поэтому используем самое современное и надежное оборудование, проверенное временем.',
	},
	{
		id: '2',
		title: 'Профессиональная команда',
		text: 'Мы тщательно отбираем кандидатов на свободные вакансии и отдаем предпочтение самым квалифицированным и талантливым специалистам. Наши врачи и ассистенты настоящие профессионалы своего дела!',
	},
	{
		id: '3',
		title: 'Качественные материалы',
		text: 'Все расходные материалы мы приобретаем только у проверенных производителей, зарекомендовавших себя как надежный партнер.',
	},
];
...
export const stuff = [
...

	{
		...
		education_years: ['',],
		education: [
			'Скоро мы обновим информацию и она станет доступна...',
		],
